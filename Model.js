      ...
      <Modal
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Image style={{width:100,height:100}} source={require('./assets/success.png')}/>
            </View>
            <Text style={styles.modalText}>Self Verification Done Successfully</Text>
            <View>
              ...
              <Text style={styles.head1}>Pass fare</Text>
              <Text style={styles.head1}>&#8377; 3650</Text>
              </View>
